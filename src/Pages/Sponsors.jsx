...
const Sponsors = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>Sponsors - College Event Management System</title>
        <meta
          name="description"
          content="Learn more about the sponsors who support our college events and make them possible."
        />
        <meta
          name="keywords"
          content="college event sponsors, event sponsors, event sponsorship"
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://event-arch.vercel.app/sponsors" />
        {/* Open Graph Tags */}
        <meta
          property="og:title"
          content="Sponsors - College Event Management System"
        />
        <meta
        ...
        <meta
          property="og:image"
          content="https://event-arch.vercel.app/images/og-sponsors.jpg"
        />
        <meta
          property="og:url"
          content="https://event-arch.vercel.app/sponsors"
        />
        ...
        <meta
          name="twitter:image"
          content="https://event-arch.vercel.app/images/twitter-sponsors.jpg"
        />
      </Helmet>
      <Navbar />
